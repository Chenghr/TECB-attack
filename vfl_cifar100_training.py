...
def main(device, args):
    ...
    for seed in range(5):
        ...
        # TODO:这里的lr_scheduler是直接写死的，需要改成自适应的
        # 注意因为这是SGD所以需要对学习率进行调整，如果是Adam则不需要
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            if args.backdoor_start:
                if (epoch + 1) < args.backdoor:
                    ...
                    train_loss, delta = vfltrainer.train_narcissus(train_queue, criterion, bottom_criterion,
                                                                   optimizer_list, device, args, delta,
                                                                   selected_indices)
            ...
            print("epoch:", epoch + 1, "train_loss:", train_loss, "test_loss: ", test_loss, "top1_acc: ", top1_acc,
        ...
        with open(args.save + '/' + txt_name + '.txt', 'a') as file:
            ...
            _, asr_top1_acc, asr_top5_acc = vfltrainer.test_backdoor_mul(non_target_queue, criterion, device, args, delta,
                                                           target_label)
            ...
            if seed == 4:
                ...
                print("ASR AVG Top1 acc: ", ASR_Top1.avg, "ASR STD Top1 acc: ", ASR_Top1.std_dev(),
                      "ASR AVG Top5 acc: ", ASR_Top5.avg, "ASR STD Top5 acc: ", ASR_Top5.std_dev())
