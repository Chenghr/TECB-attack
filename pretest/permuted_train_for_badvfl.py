...
from attack.badvfl.utils import (get_poison_test_dataloader, 
                                 init_dataloader,
                                 load_model_and_backdoor_data)
...
def permuted_validate(args, logger):
    ...
    train_dataloader, _, test_dataloader = init_dataloader(
    ...
    # _, optimizer_list, lr_scheduler_list = init_model_releated(
    ...
    poison_test_dataloader = get_poison_test_dataloader(
