...
if __name__ == "__main__":
    default_config_path = os.path.abspath("../../attack/villain/best_configs/cifar100_bestattack.yml")
    default_data_path = os.path.abspath("../../data/")
    default_save_path = os.path.abspath("../../results/models/Villain/cifar100")
    os.environ["CUDA_VISIBLE_DEVICES"] = "1"
    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    print(device)

    parser = argparse.ArgumentParser("villain_cifar100")

    # 数据相关参数
    data_group = parser.add_argument_group('Data')
    data_group.add_argument("--data_dir", default="../../data/CIFAR100/", help="location of the data corpus")
    data_group.add_argument("--dataset", default="CIFAR100", type=str, choices=[
