...
if __name__ == "__main__":
    ...
    experiment_group.add_argument("--save", default="./results/models/Villain/cifar10", type=str, metavar="PATH", help="path to save checkpoint")
    ...
    backdoor_group.add_argument("--pre_train_epoch", type=int, default=1, help="pre train epoch")
    ...
    parser.add_argument(
        "--c",
        type=str,
        default="configs/villain/cifar10_test.yml",
        help="config file",
    )
